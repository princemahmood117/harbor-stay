...
import signupAnimation from "../../assets/images/signup.json"; // 👈 import your Lottie animation
...
const SignUp = () => {
  ...
  return (
    <div className="flex justify-center items-center min-h-screen bg-gray-50 px-6">
      <div className="grid md:grid-cols-2 items-center bg-white rounded-2xl shadow-lg p-6">
        
        {/* Left Side - SignUp Form */}
        <div className="flex flex-col max-w-md p-6 rounded-md sm:p-10 bg-gray-100 text-gray-900 md:ml-8">
          <div className="mb-8 text-center">
            <h1 className="my-3 text-4xl font-bold">Sign Up</h1>
            <p className="text-sm text-gray-400">Welcome to StayVista</p>
          </div>
